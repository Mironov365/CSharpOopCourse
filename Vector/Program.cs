...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        vector3.MultiplicateByScalar(5);
        Console.WriteLine(vector3);
        Console.WriteLine();
        ...
        Console.WriteLine("Проверка корректности копирования вектора. " +
            "Заменяем 2 элемент в векторе 4 и смотрим на скопированный с него вектор 5 после изменений");
        vector4[2] = 6;
        Console.WriteLine(vector4);
        Console.WriteLine(vector5);
        Console.WriteLine();
